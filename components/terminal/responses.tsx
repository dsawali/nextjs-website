const responses = {
  about: `Hey, my name is Davis. I am a software engineer based in Vancouver, BC. I'm a passionate dev with a lot of experience in open source, library development, and automation.`,
  skills: 
  `* Languages: TypeScript, JavaScript, Python, C#, Go, Java \n* Frameworks: Next.js, React, Node.js, Express.js, Selenium, .NET, Spring \n* Tools: Git, Docker, Redis, MongoDB, PostgreSQL, Jira, Github Actions, Kafka, GraphQL`,
  projects: 
